...
bool Module::createPolydriver(std::shared_ptr<ParametersHandler::IParametersHandler> handler)
{
    ...
    {
        std::cerr << "[createPolydriver] Could not open remotecontrolboardremapper object."
                  << std::endl;
        return false;
    }
    return true;
...
bool Module::configure(yarp::os::ResourceFinder& rf)
{
    ...
    double maxValue = 0;
    parametersHandler->getParameter("max_angle_deg", maxValue);
    maxValue *= M_PI / 180;

    double minValue = 0;
    parametersHandler->getParameter("min_angle_deg", minValue);
    minValue *= M_PI / 180;

    double trajectoryDuration = 5;
    parametersHandler->getParameter("trajectory_duration", trajectoryDuration);
...
bool Module::updateModule()
{
    ...
    {
        std::cerr << "[Module::updateModule] Generate a new trajectory." << std::endl;
